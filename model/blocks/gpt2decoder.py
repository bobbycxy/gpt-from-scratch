...
class DecoderBlock(nn.Module):
    def __init__(self, num_heads, n_embed, block_size, is_causal, use_rope=False):
        super().__init__()
        head_size = n_embed // num_heads
        self.sa_head = MultiHeadAttention(head_size, num_heads, n_embed, block_size, is_causal, use_rope)
