...
cfg = {
    ...
    'block_size': 256, # T
    'n_embed': 384, # C
    'eval_iters': 200, # number of iterations to evaluate the model at a time step
    'max_iters': 5000, # number of iterations to train the model
...
wandb_run_name = 'multiheadattention-ffn-blocks-residconn-layernorm-dropout-optparams' # 'run' + str(time.time())
